...
function addSlider(name) {
  ...
  var sliderText = '<div style="width:500px; height:20px;"> <input id="' +
      divName + '" ' +
...
function addSliderOld(name) {
  ...
  var sliderText = '<div id="' + divName + '" style="width:500px;"> <div id="' +
      name + '-value" style="position:relative; left:30em;">' + name +
      '</div> </div> <br>  ';
